...
- [Feature placement rules](feedback_feature_placement.md) — Feature-specific types go in Domain/Application, not Core; export features: start with synchronous streaming, not background jobs
