...
Export
13. Convert `ProposalResult.md` to `Proposal.docx` using the adesso template selected per the **Proposal Template Selection** mapping
...
Templates are located at `/customer/adesso/assets/docs/` on the Code Interpreter image:
