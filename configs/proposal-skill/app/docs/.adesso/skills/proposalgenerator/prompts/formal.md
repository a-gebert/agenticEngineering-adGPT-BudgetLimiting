...
- Extract data from Markdown tables (pipe-delimited rows) — formal requirements are frequently embedded in tables (e.g., submission checklists, deadline tables).
